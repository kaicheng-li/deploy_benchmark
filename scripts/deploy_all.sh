...
echo "    2. 使用各框架 src/ 下的脚本进行推理和基准测试"
echo "    3. 运行各框架推理/基准测试:"
echo "       (cd vllm && python src/benchmark.py --config config.yaml)"
echo "       (cd tensorrt && python src/inference.py --config config.yaml)"
echo "       (cd onnx && python src/benchmark.py --config config.yaml)"
echo "       (cd llamacpp && python src/benchmark.py --config config.yaml)"
echo "       (cd openvino && python src/benchmark.py --config config.yaml)"
echo "============================================================================"
