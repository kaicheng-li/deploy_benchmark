...
echo ""
echo "  使用方式:"
echo "    构建引擎:  cd tensorrt && python engine_builder.py --config config.yaml"
echo "    推理:      cd tensorrt && python inference.py --config config.yaml --prompt 'Hello'"
echo "    基准测试:  cd tensorrt && python benchmark.py --config config.yaml"
